...
import utilites.Utility;
    ...
    public class TestSuite extends Utility {
        ...
        public void verifyProductAddedToShoppingCartSuccessFully1() throws InterruptedException {
            ...
            driver.findElement(By.xpath("//a[normalize-space()='Build your own computer']")).click();
            ...
            driver.findElement(By.xpath("//input[@id='BillingNewAddress_FirstName']")).sendKeys("kajal");
            driver.findElement(By.xpath("//input[@id='BillingNewAddress_LastName']")).sendKeys("Patel");
            driver.findElement(By.xpath("//input[@id='BillingNewAddress_Email']")).sendKeys("abc@gmail.com");
            ...
            driver.findElement(By.xpath("//input[@id='BillingNewAddress_Address1']")).sendKeys("20,city Road");
            driver.findElement(By.xpath("//input[@id='BillingNewAddress_ZipPostalCode']")).sendKeys("wd19 6br");
            driver.findElement(By.xpath("//input[@id='BillingNewAddress_PhoneNumber']")).sendKeys("07598368253");
            ...
            selectVisibleTextFromDropDown(By.xpath("//select[@id='CreditCardType']"),"Master card");
            driver.findElement(By.xpath("//input[@id='CardholderName']")).sendKeys("dcb");
            ...
            driver.findElement(By.xpath("//input[@id='CardCode']")).sendKeys("654");
        ...
        private void selectVisibleTextFromDropDown(By by, String value) {
