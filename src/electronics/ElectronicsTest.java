...
public class ElectronicsTest extends Utility {
    ...
    mouseHoverToElement(By.xpath("//body/div[6]/div[2]/ul[1]/li[2]/a[1]"));
      ...
      Assert.assertEquals("Verify the value is not match", expectedText2, RealText2);
        Thread.sleep(2000);
        driver.findElement(By.xpath("//input[@id='FirstName']")).sendKeys("krishna2");
        driver.findElement(By.xpath("//input[@id='LastName']")).sendKeys("patel2");
        // driver.findElement(By.xpath("//input[@id='Email']")).sendKeys("Automation_" + Number(1, 1000).ToString() + "_" + driver.RandomString(4) + "@gmail.com"););
        driver.findElement(By.xpath("//input[@id='Email']")).sendKeys("acz1234@yahoo.com");
        driver.findElement(By.xpath("//input[@id='Password']")).sendKeys("adcdef");
        driver.findElement(By.xpath("//input[@id='ConfirmPassword']")).sendKeys("adcdef");
        ...
        clickOnElement(By.xpath("//button[@id='checkout']"));
        Thread.sleep(2000);
        driver.findElement(By.xpath("//input[@id='BillingNewAddress_Company']")).sendKeys("kkP");
        ...
        driver.findElement(By.xpath("//input[@id='BillingNewAddress_Address2']")).sendKeys("City Road");
        driver.findElement(By.xpath("//input[@id='BillingNewAddress_ZipPostalCode']")).sendKeys("ha2 1fg");
        driver.findElement(By.xpath("//input[@id='BillingNewAddress_PhoneNumber']")).sendKeys("07645634256");
        driver.findElement(By.xpath("//input[@id='BillingNewAddress_FaxNumber']")).sendKeys("12342");
        ...
        Thread.sleep(1000);
       /* selectValueFromdropDown(By.xpath("(By.id(\"CreditCardType"),"visa");
        driver.findElement(By.xpath("//input[@id='CardholderName']")).sendKeys("MNmehta");*/
        selectValueFromdropDown(By.id("CreditCardType"), "visa");
        sendTextToElement(By.id("CardholderName"), "Mr.K Mehta");  //name on card
        sendTextToElement(By.id("CardNumber"), "4539926921009583");
